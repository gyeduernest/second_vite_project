...
export default function LogIn() {
  ...
  return (
    ...
    transition={{duration:0.75 , ease: "easeInOut"}}
     className='h-full bg-slate-900 lg:px-40 lg:mt-20 flex justify-center items-center '>
    ...
    <div class="mb-6">
        ...
        <p className='text-blue-300 text-left'>Forgot Password?</p>
           ...
           <NavLink to="/signup"><div><p className='text-center'>Dont have an Account? Sign up</p></div></NavLink>
